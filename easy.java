...
class easy extends JFrame {

    easy() {

        add(new MemoryGameEasy());
        setTitle("EASY");
        setSize(1000, 800);
        setResizable(false);
        setVisible(true);
...
class MemoryGameEasy extends JPanel {

    static String files[] = {"bird1.png", "chell1.png", "oc1.png", "loma1.png"};
...
// we just record index for odd clicks
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawImage(Easy.getImage(), 3, -30, 990, 790, this);
        ...
        if (aa[0] == true && aa[1] == true && aa[2] == true && aa[3] == true) {
            for (int i = 0; i < files.length*2; i++) {
                remove(buttons[i]);
            }
